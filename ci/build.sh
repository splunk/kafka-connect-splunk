...
gitversion=`2.0.0` # returns the latest tag from current commit
...
wget -q https://archive.apache.org/dist/kafka/${kafkaversion}/kafka_2.13-${kafkaversion}.tgz -P ${builddir}
...
2. Update config/connect-distributed.properties according to your env
